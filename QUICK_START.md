...
2. **Toggle the Segment Selector** to pick plan, region, channel, and variant (pure demo control)
3. **Click "Create Workspace"** ✅
4. **Click "Create Project"** ✅
5. **Click "Complete Task" 3 times** ✅
6. **Click "Send Invite"** ✅
7. **Click "View Dashboard"** to see your activation rate! 📊
